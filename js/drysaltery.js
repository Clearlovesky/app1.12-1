window.onload=function(){
	...
	aArr[0].onclick=function(){
	    ...
	    imgArr[1].src="images/干货切图/ico_shequ@2x.png";
	    imgArr[2].src="images/干货切图/ico_sport@2x.png";
	    imgArr[3].src="images/干货切图/ico_ganhuo@2x.png";
	    imgArr[4].src="images/干货切图/ico_wode@2x.png";
	...
	aArr[1].onclick=function(){
	    ...
	    imgArr[1].src="images/干货切图/ico_shequ_selected@2x.png";
	    imgArr[2].src="images/干货切图/ico_sport@2x.png";
	    imgArr[3].src="images/干货切图/ico_ganhuo@2x.png";
	    imgArr[4].src="images/干货切图/ico_wode@2x.png";
	    $(this).find("span").css("color","#F8E71C").parent("div").parent("a").siblings("a").find("span").css("color","#E3E3E3");
	...
	aArr[2].onclick=function(){
	    imgArr[0].src="images/干货切图/ico_yujian@2x.png";
	    imgArr[1].src="images/干货切图/ico_shequ@2x.png";
	    imgArr[2].src="images/干货切图/ico_sport_selected@2x.png";
	    imgArr[3].src="images/干货切图/ico_ganhuo@2x.png";
	    imgArr[4].src="images/干货切图/ico_wode@2x.png";
	    $(this).find("span").css("color","#F8E71C").parent("div").parent("a").siblings("a").find("span").css("color","#E3E3E3");
	}
	aArr[3].onclick=function(){
	    ...
	    imgArr[1].src="images/干货切图/ico_shequ@2x.png";
	    imgArr[2].src="images/干货切图/ico_sport@2x.png";
	    imgArr[3].src="images/干货切图/ico_ganhuo_selected@2x.png";
	    imgArr[4].src="images/干货切图/ico_wode@2x.png";
	    $(this).find("span").css("color","#F8E71C").parent("div").parent("a").siblings("a").find("span").css("color","#E3E3E3");
	}
	aArr[4].onclick=function(){
	    ...
	    imgArr[2].src="images/干货切图/ico_sport@2x.png";
	    imgArr[3].src="images/干货切图/ico_ganhuo@2x.png";
	    imgArr[4].src="images/干货切图/ico_wode_selected@2x.png";
	    $(this).find("span").css("color","#F8E71C").parent("div").parent("a").siblings("a").find("span").css("color","#E3E3E3");
	}
